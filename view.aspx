<%@ Page Language="VB" MasterPageFile="~/ops.master" AutoEventWireup="false" CodeFile="view.aspx.vb" Inherits="view" title="" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="sdsAllOrders" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OPSConn %>" 
        FilterExpression="{1} LIKE '{0}'" SelectCommand="admin_orders" 
        SelectCommandType="StoredProcedure">
        <FilterParameters>
            <asp:ControlParameter ControlID="txtSearch" DefaultValue="" Name="searchtext" 
                PropertyName="Text" Size="100" Type="String" />
            <asp:ControlParameter ControlID="ddlsearchby" DefaultValue="" Name="searchwhat" 
    ...
    EnableViewState="False" Width="95%" DataKeyNames="order_id">
                    ...
                    <table border="1" style="text-align: left" width="100%">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("need_by") %>'></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3"><strong>Receiving Status:</strong>
                            <asp:Label ID="lblRecdStatus" runat="server" Text='<%# Eval("recd_status") %>'></asp:Label>
                                <strong>Receiving Comments:</strong>&nbsp;<asp:Label ID="lblRecd_Comments" 
                                    runat="server" Text='<%# Eval("recd_comments") %>'></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <br />
           ...
           Text="Submit new order based on this one" 
            PostBackUrl="~/order_reuse.aspx" />
        ...
        EnableViewState="False" Width="100%">
            ...
            EnableViewState="False">
                    ...
                    <asp:ListItem Value="dafis_po_num">PO Number</asp:ListItem>
                </asp:DropDownList>
                Search Text:
        ...
        DataKeyNames="order_id" DataSourceID="sdsAllOrders" EnableViewState="False" 
        PageSize="30">
                <Columns>
                ...
                <EmptyDataTemplate>
                    No orders fit entered criteria!
                </EmptyDataTemplate>
            </asp:GridView>
        </ContentTemplate>
    </asp:UpdatePanel>
