...
-- Description:	Given a Kerberos/LoginId, Return a list of orders that the user has edit access to.
--	Notes:
--		Replaces vEditAccess.
--
...
*/
-- =============================================
CREATE FUNCTION udf_GetEditAccessOrdersForLogin
(
