...
/****** Object:  View [dbo].[vLineResults]    Script Date: 02/27/2012 09:09:37 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vLineResults]'))
DROP VIEW [dbo].[vLineResults]
GO
...
/****** Object:  View [dbo].[vLineResults]    Script Date: 02/27/2012 09:09:37 ******
 ...
 SELECT LI.[OrderId]
      ...
      ,LI.[Notes]
      ,LI.[CommodityId]
  FROM [PrePurchasing].[dbo].[vLineResults] LI
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vLineResults'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vLineResults'
GO

CREATE UNIQUE CLUSTERED INDEX [vLineResults_Id_UDX] ON [dbo].[vLineResults] 
(
[Id] ASC
)  
GO 
