...
namespace Purchasing.Tests.ControllerTests.HistoryControllerTests
{
    public partial class HistoryControllerTests
    {
        ...
        public void TestAccountsPayableOrdersWhenOrderStatusFilterIsAll1()
        {
            ...
            OrderService.Expect(
                a =>
                a.GetAccountsPayableIndexedListofOrders(Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything)).Return(rtValue);
            #endregion Arrange
            ...
            OrderService.AssertWasCalled(
                a =>
                a.GetAccountsPayableIndexedListofOrders(Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything));
            var args = OrderService.GetArgumentsForCallsMadeOn(
                a =>
                a.GetAccountsPayableIndexedListofOrders(Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything))[0];
        ...
        public void TestAccountsPayableOrdersWhenOrderStatusFilterIsAll2()
        {
            ...
            OrderService.Expect(
                a =>
                a.GetAccountsPayableIndexedListofOrders(Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<string>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything, Arg<DateTime?>.Is.Anything)).Return(
                                      rtValue);
            #endregion Arrange

            #region Act
            var result = Controller.AccountsPayableOrders("All", DateTime.Now.Date.AddDays(1), DateTime.Now.Date.AddDays(2), DateTime.Now.Date.AddDays(3), DateTime.Now.Date.AddDays(4))
                .AssertViewRendered()
                .WithViewData<FilteredOrderListModelDto>();
            #endregion Act
