...
namespace Purchasing.Tests.ServiceTests.NotificationServiceTests
{
    public partial class NotificationServiceTests
    {
        ...
        public void TestOrderApprovedKualiNoEmailPrefs1()
        {
            ...
            Assert.AreEqual(string.Format("Order request {0} has been approved by Amy Wong at Complete review.", "#testOrg-FT1P9YR"), order.EmailQueues[0].Text);
            ...
            Assert.AreEqual(string.Format("Order request {0} has been approved by Amy Wong at Complete review.", "#testOrg-FT1P9YR"), order.EmailQueues[1].Text);
            ...
            Assert.AreEqual(string.Format("Order request {0} has been approved by Amy Wong at Complete review.", "#testOrg-FT1P9YR"), order.EmailQueues[2].Text);
            ...
            Assert.AreEqual(string.Format("Order request {0} has been approved by Amy Wong at Complete review.", "#testOrg-FT1P9YR"), order.EmailQueues[3].Text);
            #endregion Assert
        }
