<%@ Page Language="VB" MasterPageFile="~/ops.master" AutoEventWireup="false" CodeFile="admin_approve.aspx.vb" Inherits="admin_approve" title="" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="sdsAllOrders" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OPSConn %>" 
        FilterExpression="{1} LIKE '{0}'" SelectCommand="admin_approve" 
    ...
    <br />
        ...
        EnableViewState="False" PageSize="30" Width="100%">
                        <Columns>
