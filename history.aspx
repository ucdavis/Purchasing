<%@ Page Language="VB" MasterPageFile="~/ops.master" AutoEventWireup="false" CodeFile="history.aspx.vb" Inherits="history" title="" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="sdsMSDSAll" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OPSConn %>" 
        FilterExpression="{1} LIKE '{0}'" SelectCommand="history_select" 
        ...
        EnableViewState="False" Width="95%">
                ...
                Text='<%# Bind("approved_by") %>'></asp:Label>
                    ...
                    <table border="1" style="text-align: left" width="100%">
                        ...
                        <tr>
                            <td>
                                            ...
                                            <asp:CheckBox ID="csCheckBox" runat="server" 
                                                Checked='<%# Bind("controlled_substance") %>' Enabled="False" />
                        ...
                        <tr>
                            <td colspan="2">
                                <strong>Quote is being sent to purchasing desk?:</strong><asp:CheckBox ID="attachmentCheckBox" runat="server" 
                        ...
                        <tr>
                            <td colspan="2">
                                <strong>Vendor contact:</strong><asp:Label ID="vendor_contactLabel" runat="server" 
                            Text='<%# Bind("vendor_contact") %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="height: 23px">
                                <strong>Request comments:</strong><asp:Label ID="request_commentsLabel" runat="server" 
