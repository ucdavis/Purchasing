<%@ Page Language="VB" MasterPageFile="~/ops.master" AutoEventWireup="false" CodeFile="view_orders.aspx.vb" Inherits="view_orders" title="" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <asp:SqlDataSource ID="sdsAllOrders" runat="server" 
    ConnectionString="<%$ ConnectionStrings:OPSConn %>" 
    FilterExpression="{1} LIKE '{0}'" SelectCommand="nonadmin_orders" 
