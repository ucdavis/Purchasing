<%@ Page Title="" Language="VB" MasterPageFile="~/ops.master" AutoEventWireup="false" CodeFile="lab_orders.aspx.vb" Inherits="lab_orders" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <asp:SqlDataSource ID="sdsAllOrders" runat="server" 
    ConnectionString="<%$ ConnectionStrings:OPSConn %>" 
    FilterExpression="{1} LIKE '{0}'" SelectCommand="lab_orders" 
    ...
    EnableViewState="False" Width="95%" DataKeyNames="order_id">
        ...
        EnableViewState="False" Width="100%">
            ...
            RepeatDirection="Horizontal" RepeatLayout="Flow">
                    ...
                    <asp:ListItem Selected="True" Value="2 Months |">2 Months |</asp:ListItem>
            ...
            EnableViewState="False">
                ...
                (use leading and/or trailing % for wildcard)
