<%@ Page Language="VB" MasterPageFile="~/ops.master" AutoEventWireup="false" CodeFile="history_admin.aspx.vb" Inherits="history_admin" title="" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="sdsHistory" runat="server" 
        ConnectionString="<%$ ConnectionStrings:OPSConn %>" 
        FilterExpression="{1} LIKE '{0}'" SelectCommand="admin_history_select" 
        ...
        <SelectParameters>
            ...
            <asp:SessionParameter Name="app_id" SessionField="app_id" />
        </SelectParameters>
    </asp:SqlDataSource>
                ...
                Text='<%# Bind("approved_by") %>'></asp:Label>
                            ...
                            Text='<%# Bind("full_tag") %>'></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong>Ship To:</strong><asp:Label ID="ship_toLabel" runat="server" Text='<%# Bind("ship_to") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
