<%@ Page Language="C#" MasterPageFile="~/master/default.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="dpo.aspx.cs" Inherits="business_purchasing_orders_dpo" Title="Untitled Page" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="../blocks/dpo_items.ascx" TagName="dpo_items" TagPrefix="uc1" %>
    ...
    <!--
        ...
        function OnSubmit(source, args) {
            ...
            for (var i = 0; i <= 14; i = i + 1) {
                ...
                var quantity = document.getElementById("ctl00_MainContentPlaceHolder_dpo_items1_qtyRadNumericTextBox" + i + "_text").value;
                var unit = document.getElementById("ctl00_MainContentPlaceHolder_dpo_items1_unitTextBox" + i).value;
                var catalogNum = document.getElementById("ctl00_MainContentPlaceHolder_dpo_items1_catalogTextBox" + i).value;
                var desc = document.getElementById("ctl00_MainContentPlaceHolder_dpo_items1_descTextBox" + i).value;
                var unitPrice = document.getElementById("ctl00_MainContentPlaceHolder_dpo_items1_costRadNumericTextBox" + i + "_text").value;

                if (quantity || catalogNum || desc || unitPrice) {
                    if (quantity == null || quantity == "" || unit == null || unit == "" || catalogNum == null || catalogNum == "" || desc == null || desc == "" || unitPrice == null || unitPrice == "")
...
<asp:Content ID="Content2" runat="Server" ContentPlaceHolderID="MainContentPlaceHolder">
    ...
    <div id="formwrap">
                        ...
                        <table cellspacing="0" class="standard_tbl" style="width: 100%; font-size: 11px;">
                            ...
                            <tr>
                                <td style="padding: 3px 10px 15px 10px; vertical-align: top; text-align: center;">I approve this order and authorize the charge of
                                    ...
                                    (<a href="#change" class="bdrLink">change account</a>).</td>
        ...
        <asp:MultiView ID="dpoMultiView" runat="server">
            <asp:View ID="View_Order" runat="server">
                <telerik:RadFormDecorator ID="pageRadFormDecorator" DecoratedControls="All" runat="server" />
                    ...
                    <asp:View ID="View_ShipTo_New" runat="server">
                        <table cellpadding="0" cellspacing="0" class="formtable bdrlft">
                            ...
                            <tr>
                                <td>Zip: </td>
                                <td>
                                    <telerik:RadNumericTextBox ID="shiptoZipRadNumericTextBox" BackColor="LemonChiffon" Width="50" Type="Number" NumberFormat-GroupSizes="5" Skin="" MaxLength="5" NumberFormat-DecimalDigits="0" InvalidStyle-BackColor="Red" runat="server">
                                    </telerik:RadNumericTextBox>
                                    -
                                    <telerik:RadNumericTextBox ID="shiptoZipPlusRadNumericTextBox" BackColor="LemonChiffon" NumberFormat-GroupSizes="4" Width="40" Type="Number" Skin="" MaxLength="4" NumberFormat-DecimalDigits="0" InvalidStyle-BackColor="Red" runat="server">
                                    </telerik:RadNumericTextBox>
                            ...
                            <tr class="alt">
                                <td>Phone: </td>
                                <td>
                                    <telerik:RadMaskedTextBox ID="shiptoPhoneRadMaskedTextBox" BackColor="LemonChiffon" InvalidStyle-BackColor="Red" ClientEvents-OnFocus="OnFocus" runat="server" Mask="(###) ### - ####" ResetCaretOnFocus="true" Width="120px" Skin="">
                ...
                <br />
                <uc1:dpo_items ID="dpo_items1" runat="server" />
                <br />
                <br />
                <table class="formtable bdrlft" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="hide" runat="server" id="Tr3" style="display: none;">
                        ...
                        <td>
                            ...
                            &nbsp;<a href="#" rel="3" class="jRemove bdrLink">Remove</a> </td>
                    </tr>
                    <tr class="hide" runat="server" id="Tr4" style="display: none;">
                        ...
                        <td>
                            ...
                            &nbsp;<a href="#" rel="4" class="jRemove bdrLink">Remove</a> </td>
                    </tr>
                    <tr class="hide" runat="server" id="Tr5" style="display: none;">
                        ...
                        <td>
                            ...
                            &nbsp;<a href="#" rel="5" class="jRemove bdrLink">Remove</a> </td>
                    </tr>
                    <tr class="alt">
                    ...
                    <tr class="alt">
                        <td id="accountCell1" runat="server">Account:<a name="change" id="change"></a></td>
                    ...
                    <tr class="alt">
                        ...
                        <td>
                            <telerik:RadUpload ID="dpoRadUpload" runat="server" ControlObjectsVisibility="AddButton, RemoveButtons" InitialFileInputsCount="0" InputSize="15" Width="400px">
            ...
            <asp:View ID="View_Requisition" runat="server">
                ...
                <table class="formtable bdr" cellspacing="0">
                    <tr class="alt">
                        <td colspan="2">If you would like your purchasing agent to submit the supporting documents to the UC Davis Purchasing Department for you, attach the documents <strong>in PDF or MS Word format</strong> below and click the "Submit Requisition with Supporting Documents" button. [<a href="http://purchasing.ucdavis.edu/geninfo/solesource.cfm">More information</a>]</td>
                    </tr>
                    <tr class="alt">
