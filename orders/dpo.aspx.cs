...
public partial class business_purchasing_orders_dpo : System.Web.UI.Page
{
    // Paths
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            sectionTitleLabel.Text = "Departmental Purchase Order";
            dpoMultiView.SetActiveView(View_Order);
            ...
            if (Request.QueryString["order"] != null)
            {
                ...
                if (PurchaseHelper.OrderExists(orderID))
                {
                    ...
                    dpo_items1.PopulateItems(orderID);
            ...
            else
            {
                ...
                shiptoNameTextBox.Text = Users.GetFullNameByUserName(User.Identity.Name, false, false);

                // Get last order
                PurchasingTableAdapters.ordersTableAdapter ordersAdapter = new PurchasingTableAdapters.ordersTableAdapter();
                Purchasing.ordersDataTable dt = ordersAdapter.GetTop(User.Identity.Name, Convert.ToInt32(PurchaseHelper.OrderType.DPO));
    ...
    protected void PopulateOrder(int orderID)
    {
        ...
        {
            //////////////////////////// Order preferences ///////////////////////////////
            sectionTitleLabel.Text = "Departmental Purchase Order #" + dr.unique_id;
    ...
    protected void HandleIE()
    {
        ...
        if (browser.Browser == "IE")
            pageRadFormDecorator.DecoratedControls = FormDecoratorDecoratedControls.None;
    }
    ...
    protected void BindPIs()
    {
        piRadComboBox1.DataSource =
            ...
            piRadComboBox5.DataSource = Users.GetUsersByRoleName("PurchaseApprover", false);
    ...
    {
        int orderID = 0;
        double subtotal = dpo_items1.GetOrderSubTotal();
        ...
        try
        {
            ...
            orderID = Convert.ToInt32(ordersAdapter.InsertOrder(
                ...
                Convert.ToInt32(PurchaseHelper.OrderType.DPO),
        ...
        if (orderID > 0)
        {
            ...
            string orderTable = dpo_items1.GetHTMLTable();
            dpo_items1.InsertItems(orderID);
            ...
            if (dpoRadUpload.UploadedFiles.Count > 0)
    ...
    protected void OverTotal()
    {
        ...
        dpoMultiView.SetActiveView(View_Requisition);
    ...
    {
        dpoMultiView.SetActiveView(View_Confirm);
        ...
        if (error)
        {
            MailHelper.SendMailMessage(
                ...
                String.Empty,
                String.Empty,
                "DPO Error: " + PurchaseHelper.ProfileInfo(User.Identity.Name, false),
    ...
    protected void approveButton_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            try
            {
                ...
                PurchasingTableAdapters.dpo_itemsTableAdapter itemsAdapter = new PurchasingTableAdapters.dpo_itemsTableAdapter();
                itemsAdapter.DeleteByOrder(orderID);
                string itemsTable = dpo_items1.GetHTMLTable();
                dpo_items1.InsertItems(orderID);
    ...
    protected void updateButton_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            if ((dpo_items1.GetOrderSubTotal() * 1.0775) < 4999.99)
            {
                int orderID = Convert.ToInt32(Request.QueryString["order"]);
                ...
                try
                {
                    ...
                    PurchasingTableAdapters.ordersTableAdapter ordersAdapter = new PurchasingTableAdapters.ordersTableAdapter();
                    ordersAdapter.UpdateTotal(orderID, Convert.ToDecimal(dpo_items1.GetOrderSubTotal()));
                    ...
                    string account = accountTextBox.Text.Trim();
                    double subtotal = dpo_items1.GetOrderSubTotal() * 1.0775;
                    string orderTable = dpo_items1.GetHTMLTable();
    ...
    protected void submitLinkButton_Click(object sender, EventArgs e)
    {
        if ((dpo_items1.GetOrderSubTotal() * 1.0775) < 4999.99)
        {
            ...
            else
            {
                ...
                "DPO error when submitting request: " + PurchaseHelper.ProfileInfo(User.Identity.Name, false) + " - Page valid? " + Page.IsValid.ToString(),
                true,
                String.Empty
                );
            }
    ...
    {
        // Validate uploads
        string saveToPath = Server.MapPath(savePath);
        string fileLinks = String.Empty;
        bool valid = true;
