                ...
                $.getJSON(options.PeepsUrl, { orderStatusCodeId: role }, function (result) {
                    ...
                    if (result && result) {
                        $(result.peeps).each(function () {
                            dialogList.append("<li><span>" + this.FullName + "<span>  <a target='_blank' href='http://directory.ucdavis.edu/search/directory_results.shtml?filter=" + this.Email + "'><span style='color: blue; text-decoration: underline;'><i>[Lookup]</i></span></a></li>");
                        });
