<%@ Page Language="VB" MasterPageFile="~/ops_viewstate.master" AutoEventWireup="false"
    CodeFile="order.aspx.vb" Inherits="order" Trace="false" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:SqlDataSource ID="sdsVendors" runat="server" ConnectionString="<%$ ConnectionStrings:OPSConn %>"
        SelectCommand="select_vendor" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    <asp:SqlDataSource ID="sdsPreOrderInfo" runat="server" ConnectionString="<%$ ConnectionStrings:OPSConn %>"
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="ddlVendor" Name="vendor_id" PropertyName="SelectedValue"
                Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sdsInsertOrderRequest" runat="server" 
        ...
        <InsertParameters>
            ...
            <asp:SessionParameter Name="submitted_by" SessionField="emp_id" 
                Type="String" />
            <asp:ControlParameter ControlID="ddlVendor" Name="vendor_id" 
  ...
  <asp:Label ID="Label1" runat="server"></asp:Label>
            <asp:Panel ID="pnlSelectVendor" runat="server" Width="100%">
                Select a Vendor for the Order Request or <a href="add_vendor.aspx">Add a New Vendor</a><br />
                If you add a new vendor, refresh/reload this page upon return.
                <br />
                <br />
                <br />
                <asp:DropDownList ID="ddlVendor" runat="server" DataSourceID="sdsVendors" DataTextField="vendor_name"
            DataValueField="vendor_id">
                </asp:DropDownList>
                <cc1:listsearchextender id="ddlVendor_ListSearchExtender" runat="server" enabled="True"
            issorted="True" targetcontrolid="ddlVendor">
            ...
            <br />
            <asp:Panel ID="pnlOrder" runat="server" HorizontalAlign="Left" 
    Visible="False" Width="100%">
                ...
                <table border="1" width="100%">
                    <tbody>
                        <tr>
                            <td rowspan="10" style="width: 30%; height: 40px" valign="top">
                                ...
                                Height="50px" HorizontalAlign="Left" Width="100%">
                                    <Fields>
                                        <asp:BoundField DataField="vendor_name" SortExpression="vendor_name">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="address" HtmlEncode="False" ReadOnly="True" SortExpression="address">
                                        </asp:BoundField>
                                        <asp:BoundField DataField="csz" ReadOnly="True" SortExpression="csz">
                                        </asp:BoundField>
                        ...
                        <tr>
                            <td align="left">
                                <strong><span style="color: #ff0000">*Contact:</span></strong>
                                <asp:TextBox
                            ID="txtContact" runat="server"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <b>Ship to:</b>
                                <asp:DropDownList ID="ddlShipStation" runat="server" DataSourceID="sdsBldNames" DataTextField="bld_name" DataValueField="bld_name">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                                ...
                                <asp:CheckBox ID="ckbxRadioactive" runat="server">
                                </asp:CheckBox>
                                <strong>RUA#:</strong>
                        ...
                        <tr>
                            <td align="left">
                                ...
                                ControlToValidate="txtCSClass" ErrorMessage="Class/Schedule is required"></asp:RequiredFieldValidator>
                                    ...
                                    <br />
                                    <b style="color: #ff0000">*Authorized End User(s): </b><asp:TextBox ID="txtCSUser" runat="server" 
                        ...
                        Exceed amount&quot; or &quot;Unit Cost&quot; for each item)<br />
                                <table border="1" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty1" runat="server" Width="25px"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtQty1" ErrorMessage="You must provide a quantity for item #1">*</asp:RequiredFieldValidator>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDescription1" runat="server" Rows="3" TextMode="MultiLine" Width="300px"></asp:TextBox>
                                                <asp:RequiredFieldValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed1" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost1" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CustomValidator
                                            ID="CustomValidator1" runat="server" ErrorMessage="You must provide a 'not to exceed' or 'unit cost' for item #1">*</asp:CustomValidator>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty2" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CustomValidator
                                            ID="CustomValidator2" runat="server" ControlToValidate="txtContact" ErrorMessage="Item #2 has an error. Please ensure you have provided quantity (valid number), unit, description, and a 'not to exceed' or 'unit cost' (with valid currency format)">*</asp:CustomValidator>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed2" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost2" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty3" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed3" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost3" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty4" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed4" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost4" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty5" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed5" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost5" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty6" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed6" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost6" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty7" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed7" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost7" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty8" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed8" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost8" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty9" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed9" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost9" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtQty10" runat="server" Width="25px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExceed10" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCost10" runat="server" Width="100px"></asp:TextBox>
                                                <asp:CompareValidator
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <asp:Button ID="Button1" runat="server" Text="Preview Order/Calculate Totals">
                                </asp:Button>
                            </td>
                        </tr>
                    </tbody>
            ...
            <asp:Panel ID="pnlReview" runat="server" Visible="False" Width="95%">
                <TABLE border="1" width="100%">
                    <tbody>
                        <tr>
                            <td rowspan="9" style="WIDTH: 30%; HEIGHT: 40px" valign="top">
                                <strong>Vendor Info<br />
                                <asp:DetailsView 
            ...
            Font-Bold="False" Height="50px" HorizontalAlign="Left" Width="100%">
                                    <Fields>
                                        <asp:BoundField 
                    DataField="vendor_name" SortExpression="vendor_name"></asp:BoundField>
                                        <asp:BoundField 
                    DataField="address" ReadOnly="True" SortExpression="address"></asp:BoundField>
                                        <asp:BoundField 
                    DataField="csz" ReadOnly="True" SortExpression="csz"></asp:BoundField>
                                        <asp:TemplateField></asp:TemplateField>
                                        <asp:BoundField 
                    DataField="phone" DataFormatString="Phone: {0}" SortExpression="phone"></asp:BoundField>
                                        <asp:BoundField 
                    DataField="fax" DataFormatString="Fax: {0}" SortExpression="fax"></asp:BoundField>
                                        <asp:HyperLinkField 
                    DataNavigateUrlFields="website" DataTextField="vendor_name"></asp:HyperLinkField>
                            ...
                            <td align="left">
                                ...
                                <asp:Label 
            ID="lblContact" runat="server" Text="Label"></asp:Label>
                                <strong>*Phone: </strong>
                                <asp:Label 
            ID="lblPhone" runat="server" Text="Label"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td 
            ...
            runat="server" Text="Label"></asp:Label>
                        ...
                        <tr>
                            <td align="left">
                                <strong>ID#:</strong>
                                <asp:Label 
            ID="lblAcct" runat="server" Text="Label"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td 
            ...
            runat="server" Text="Label"></asp:Label>
                                ...
                                <asp:Label 
            ID="lblShipto" runat="server" Text="Label"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td 
            align="left">
                                <strong>Radioactive?:</strong>
                                <asp:Label ID="lblRadioactive" 
            runat="server" Text="Label"></asp:Label>
                                <strong>RUA#:</strong>
                                <asp:Label 
            ID="lblRUA" runat="server" Text="Label"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                                <strong>Controlled Substance?:</strong> <asp:Label ID="lblControlledSubstance" runat="server" Text="Label" />
                                <strong>Class/Schedule: </strong> <asp:Label ID="lblCSClass" runat="server" Text="Label" />
                                <strong>Use: </strong> <asp:Label ID="lblCSUse" runat="server" Text="Label" />
                                <strong>Storage site:</strong> <asp:Label ID="lblCSStore" runat="server" Text="Label" />
                                <strong>Custodian: </strong> <asp:Label ID="lblCSCustodian" runat="server" Text="Label" />
                                <strong>User(s): </strong> <asp:Label ID="lblCSUsers" runat="server" Text="Label" />
                                &nbsp;</td>
                        </tr>
                        <tr>
                            <td 
            ...
            runat="server" Text="Label"></asp:Label>
                        ...
                        <tr>
                            <td align="left">
                                <strong>Vendor contact:</strong>
                                <asp:Label 
            ID="lblVContact" runat="server" Text="Label"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td 
            ...
            align="center" colspan="2">
                                <strong>ITEMS<br />
                                </strong>(*note: you must fill in either &quot;Not to Exceed amount&quot; or &quot;Unit Cost&quot; 
                                for each item)<br />
                                <table border="1" width="100%">
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr ID="tr1" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty1" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblExceed1" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td>
                                                <asp:Label ID="lblCost1" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td style="WIDTH: 94px">
                                        ...
                                        <tr ID="tr2" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty2" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblExceed2" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td>
                                                <asp:Label ID="lblCost2" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td style="WIDTH: 94px">
                                        ...
                                        <tr ID="tr3" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty3" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblExceed3" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td>
                                                <asp:Label ID="lblCost3" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal3" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr ID="tr4" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty4" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblExceed4" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td>
                                                <asp:Label ID="lblCost4" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal4" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr ID="tr5" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty5" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblUnit5" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblItem5" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td>
                                                <asp:Label ID="lblDescription5" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblExceed5" runat="server" Text="Label"></asp:Label>
                                                &nbsp;
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCost5" runat="server" Text="Label"></asp:Label>
                                                &nbsp;</td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal5" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr ID="tr6" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty6" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblUnit6" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblItem6" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblDescription6" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblExceed6" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCost6" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal6" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr ID="tr7" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty7" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblUnit7" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblItem7" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblDescription7" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblExceed7" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCost7" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal7" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr ID="tr8" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty8" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblUnit8" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblItem8" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblDescription8" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblExceed8" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCost8" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal8" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr ID="tr9" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty9" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblUnit9" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblItem9" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblDescription9" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblExceed9" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCost9" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal9" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr ID="tr10" runat="server">
                                            <td>
                                                <asp:Label ID="lblQty10" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblUnit10" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblItem10" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblDescription10" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblExceed10" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblCost10" runat="server" Text="Label"></asp:Label>
                                            </td>
                                            <td style="WIDTH: 94px">
                                                <asp:Label ID="lblTotal10" runat="server" Text="Label"></asp:Label>
                                            </td>
                                        </tr>
                                ...
                                aware of the University’s purchasing policies (PPM 350).<p>
                                    Campus purchasing policies are available on-line at:
                                    <a href="http://manuals.ucdavis.edu/ppm/contents.htm#350" target="_blank">
                                    http://manuals.ucdavis.edu/ppm/contents.htm#350</a></p>
                                <p>
                                    The University’s policy regarding conflict of interest in purchasing summary is 
                                    available on-line at: <a href="http://manuals.ucdavis.edu/directory/coi.htm" 
                                        target="_blank">http://manuals.ucdavis.edu/directory/coi.htm</a></p>
                                <p>
                                    By clicking &quot;Place Order&quot;, you agree to the above statements.<br />
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="2">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="Button3" runat="server" Text="Edit Order" />
                            </td>
                        </tr>
                    </tbody>
                </TABLE>
            ...
            <asp:Panel ID="pnlTest" runat="server" Width="75%" Visible="False">
                ...
                <br />
                REmailName: &quot;<asp:Label ID="lblREmailName" runat="server"></asp:Label>
                &quot;<br />
                AuthName
                <asp:Label ID="lblAuthorizerName" runat="server"></asp:Label>
                <br />
                Approved:
