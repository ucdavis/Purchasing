...
-- Modifications:
--
--	2012-05-31 by kjt: Revised to use split database, i.e. PrePurchasing and PrePurchasingLookups.
-- =============================================
...
BEGIN
	...
	SELECT TOP 100 PERCENT [Id]
      ...
      ,[LastUpdateDate]
      ,[IsActive]
  FROM [PrePurchasingLookups].[dbo].[vBuildings] SEARCH_TBL
  INNER JOIN FREETEXTTABLE([PrePurchasingLookups].[dbo].[vBuildings], ([BuildingCode], [BuildingName]), @ContainsSearchCondition) KEY_TBL on SEARCH_TBL.Id = KEY_TBL.[KEY]
