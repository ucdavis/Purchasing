...
BEGIN
	...
	SELECT TOP 20
		   [Id]
		  ,[Name]
	FROM [PrePurchasingLookups].[dbo].[vVendors] FT_TBL INNER JOIN
	FREETEXTTABLE([PrePurchasingLookups].[dbo].[vVendors], [Name], @ContainsSearchCondition) KEY_TBL on FT_TBL.Id = KEY_TBL.[KEY]
	WHERE [IsActive] = 1
